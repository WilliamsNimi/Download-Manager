...
public class DownloadManager extends JFrame implements Observer{
    ...
    public DownloadManager(){
        ...
        renderer.setStringPainted(true); //Allow progress text
        table.setDefaultRenderer(JProgressBar.class, renderer);
        
        //Set tables's row height large enough to fit JProgressBar.
    ...
    /*
     * if not in the middle of clearing a download, set the selected download and register
